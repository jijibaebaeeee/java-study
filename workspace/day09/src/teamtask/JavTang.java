...
//	   
//	   // 더하기
//	   System.out.printf("%d + %d = %d\n", arr[0], arr[1], jt.add(arr));
//	   System.out.printf("%d - %d = %d\n", arr[0], arr[1], jt.subtract(arr));
//	   System.out.printf("%d * %d = %d\n", arr[0], arr[1], jt.multiply(arr));
//	   if(arr[1]==0){    // 수정필요함
//		   System.out.println("0으로는 나눌 수 없습니다.");
//	   }else {
//		   System.out.printf("%d / %d = %.2f\n", arr[0], arr[1], jt.devide(arr));     
//	   }
...
//      }
		...
		while (true) {
			// id 중복체크 함수 출력
			if (jt.idCheck(id).equals("false")) { // false = 중복이면
				break;
			}
			...
			if (jt.nameCheck(nickName).equals("false")) {
...
//			pwAscii = jt.pwCheck(pw, pwCheck);
		...
		//   └ 배열, 메소드, for문, if문, 형변환
			...
			System.out.println(nickName + "님 환영합니다, 아이디는 " + id + ", 비밀번호는 " + "암호화된 {" + jt.pwCheck(pw, pwCheck) + "} 입니다");
			
			System.out.printf("%s님 환영합니다, 아이디는 %s, 비밀번호는 암호화된 { %s } 입니다. ", nickName, id, args,  jt.pwCheck(pw, pwCheck));
			break;
